...
/**
 * 构造FiberRootNode，rootFiber，初始化UpdateQueue队列
 * 建立它们之间的引用关系（current和stateNode）
 */
export function createFiberRoot(
  ...
  // 创建FiberRootNode根节点，全局只有一个
  const root: FiberRoot = (new FiberRootNode(containerInfo, tag, hydrate): any);


  // Cyclic construction. This cheats the type system right now because
  // stateNode is any.
  // 创建rootFiber节点，一个FiberRootNode可以挂载多个rootFiber
  ...
  // 初始化updateQueue，
  // 对于RootFiber，queue.share.pending上面存储着React.element
